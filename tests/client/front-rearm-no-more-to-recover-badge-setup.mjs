// Setup for tests/client/front-rearm-no-more-to-recover-badge.test.tsx (Task #4445 sweep).
...
// Passed via `--import ./tests/client/front-rearm-no-more-to-recover-badge-setup.mjs`.
