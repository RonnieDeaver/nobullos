// Setup for tests/client/front-coverage-floor-summary.test.tsx (Task #2802).
    ...
    // This suite asserts the denominator-floor reconciliation summary banner, which the panel gates on user.role
    ...
    // Passed via `--import ./tests/client/front-coverage-floor-summary-setup.mjs`.
