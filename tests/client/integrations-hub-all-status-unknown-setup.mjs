// Setup for tests/client/integrations-hub-all-status-unknown.test.tsx (Task #4445 sweep).
...
// Passed via `--import ./tests/client/integrations-hub-all-status-unknown-setup.mjs`.
