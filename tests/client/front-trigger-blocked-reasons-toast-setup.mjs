// Setup for tests/client/front-trigger-blocked-reasons-toast.test.tsx (Task #4445 sweep).
...
// Passed via `--import ./tests/client/front-trigger-blocked-reasons-toast-setup.mjs`.
