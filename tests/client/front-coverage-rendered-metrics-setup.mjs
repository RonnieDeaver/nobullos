// Setup for tests/client/front-coverage-rendered-metrics.test.tsx (Task #4445 sweep).
...
// Passed via `--import ./tests/client/front-coverage-rendered-metrics-setup.mjs`.
