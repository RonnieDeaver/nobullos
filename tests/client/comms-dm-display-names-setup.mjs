// Setup for tests/client/comms-dm-display-names.test.tsx (Task #3357).
// Reuses the pin-collapse harness: stubs the heavy leaves of the Comms.tsx
// import graph (LiveKit, message pane, composer, panels — none rendered by
// CommsSidebar) plus CSS, and redirects CommsContext to the lightweight shim.
// Passed via `--import ./tests/client/comms-dm-display-names-setup.mjs`.
