// Setup for tests/client/integrations-hub-reconnect-required-badge.test.tsx (Task #4445 sweep).
...
// Passed via `--import ./tests/client/integrations-hub-reconnect-required-badge-setup.mjs`.
