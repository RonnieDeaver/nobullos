// Setup for tests/client/front-coverage-error-reason.test.tsx (Task #2182).
    ...
    // This suite asserts the coverage table's plain-English error reason column, which the panel gates on user.role
    ...
    // Passed via `--import ./tests/client/front-coverage-error-reason-setup.mjs`.
