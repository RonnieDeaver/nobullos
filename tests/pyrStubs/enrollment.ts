// Stub for server/services/adsOs/enrollment.ts (see ads-os-pyramid-hooks.mjs).
// Shadows the three network-backed lookups the pyramid engine uses; everything
...
const g = (): State => ((globalThis as any).__pyrTest ??= {});
